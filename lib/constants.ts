...
export const APP_NAME = "TravelOne";
export const APP_URL = "https://travelone.app";
...
export const HotelData = [
  {
    ...
    description:
      "A luxurious hotel with breathtaking views of the sunset, offering world-class amenities and exceptional hospitality.",
    ...
    amenities: ["Free WiFi", "Gym", "Spa", "Room Service", "Airport Pickup"],
    hotelImages: [
  ...
  },
  {
    ...
    description:
      "Nestled in the hills, this retreat offers a tranquil escape with cozy rooms and personalized service.",
    ...
    amenities: ["Free Breakfast", "Hiking Trails", "Bonfire", "Room Service"],
    hotelImages: [
  ...
  },
  {
    ...
    description:
      "A modern hotel in the heart of the city, designed for comfort and convenience for business and leisure travelers.",
